...
function deviceFinderSlow(host) {
            ...
            ping.sys.probe(host.ip, async function(isAlive){
                ...
                if(isAlive){
                    ...
                    if(aliveHost.vendor == null){
                       deviceFinderSlow(aliveHost);                                    // Call Function => Return Device from Slow script
                    }else{
